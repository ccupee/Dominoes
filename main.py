    ...
    while flag == -2:
        ...
        if status == 'player':
            ...
            while True:
                ...
                try:
                    new_domino = random.randint(-len(computer_pieces), len(computer_pieces))
                    if new_domino < 0 and check_left(computer_pieces, snake_domino, new_domino) is False:
                        continue
                    elif new_domino > 0 and check_right(computer_pieces, snake_domino, new_domino) is False:
                        continue
                except Exception:
                    pass
                else:
                    break
            if new_domino < 0:
                make_left(computer_pieces, snake_domino, new_domino)
            elif new_domino > 0:
                make_right(computer_pieces, snake_domino, new_domino)
            elif new_domino == 0 and len(stock_pieces) != 0:
                new_piece = random.choice(stock_pieces)
